...
import static es.iessaladillo.pedrojoya.pr05.utils.KeyboardUtils.hideSoftKeyboard;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void save() {
        if (!ValidationUtils.isValidForm(txtEmail.getText().toString(), txtPhonenumber.getText().toString(), txtWeb.getText().toString(), txtName.getText().toString(), txtAddress.getText().toString())) {
